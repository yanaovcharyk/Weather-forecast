...
export const CurrentWeatherCard = () => {
  ...
  const { cityName, weather, cityLoading, weatherLoading, error } =
    useCityWeather();

  if (cityLoading || weatherLoading || !cityName || !weather?.current) {
    return (
      <DataBoundary
        error={error}
        errorTitle="Failed to load current weather"
