...
} from './current-weather.fixture';
export { forecastWithoutListFixture } from './forecast-without-list.fixture';
export { forecastWithoutTimezoneFixture } from './forecast-without-timezone.fixture';
export {
